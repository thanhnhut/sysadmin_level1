...
*Hình 1-1 Web clients and servers*

![1](https://github.com/thanhnhut/sysadmin_level1/blob/master/Task23_HTTP_The_Difinitive_Guide_Page_3to7/Images/1.jpg)
...
*Hình 1-2 Một nguồn tài nguyên web là bất cứ điều gì mà cung cấp nội dung web*

![2](https://github.com/thanhnhut/sysadmin_level1/blob/master/Task23_HTTP_The_Difinitive_Guide_Page_3to7/Images/2.png)
...
*Hình 1-3. loại MIME được gửi trở lại với nội dung dữ liệu*

![3](https://github.com/thanhnhut/sysadmin_level1/blob/master/Task23_HTTP_The_Difinitive_Guide_Page_3to7/Images/3.png)
...
*Hình 1-4. URLs chỉ định giao thức, máy chủ, và tài nguyên địa phương*

![4](https://github.com/thanhnhut/sysadmin_level1/blob/master/Task23_HTTP_The_Difinitive_Guide_Page_3to7/Images/4.png)
